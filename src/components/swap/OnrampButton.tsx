...
export function OnrampButton() {
  ...
  return (
    <>
      <div 
        className="relative mt-4 p-[1px] rounded-[1rem] bg-[conic-gradient(from_180deg_at_50%_50%,#79DBD2_0deg,#45E1E5_90deg,#B82EA4_172.8deg,#FF9533_230.4deg,#0052FF_306deg,#7FD057_360deg)] cursor-pointer"
        onClick={handleClick}
      >
        <div className="rounded-[1rem] p-4 bg-[#0A0B0D] flex justify-between">
          <div>
            ...
            <p className="text-white/60 text-[13px] tracking-tight">Buy crypto directly to your wallet</p>
          </div>
